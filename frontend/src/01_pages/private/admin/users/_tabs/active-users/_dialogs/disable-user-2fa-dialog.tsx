...
// Component Props
type DisableUser2faDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const DisableUser2faDialog = ({
  open,
  setOpen,
  refetch,
}: DisableUser2faDialogProps) => {
  // Access store values
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast.promise(mainInstance.delete(`/users/${selectedUser?.id}/2fa`), {
      loading: 'Loading...',
      success: () => {
        refetch();
      ...
      <DialogContent>
        ...
        <form onSubmit={onSubmit}>
          ...
          <DialogBody>
            ...
            {/* Modal title */}
            <h3 className="text-center text-xl">Disable 2FA</h3>
...
export default DisableUser2faDialog;
