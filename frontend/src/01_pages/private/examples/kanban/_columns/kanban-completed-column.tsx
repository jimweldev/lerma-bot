...
const KanbanCompletedColumn = ({ searchTerm }: KanbanColumnProps) => {
  ...
  const {
    ...
    params: `sort=-id&limit=10&status=Completed&search=${searchTerm}`,
  });
    ...
    >
      <div className="bg-card sticky top-0 z-10 flex items-center justify-between border-b-2 p-2">
        <div className="flex gap-2">
          <h5 className="text-xs font-semibold">Completed</h5>{' '}
      ...
      <InfiniteScroll
        scrollableTarget="container-completed"
...
export default KanbanCompletedColumn;
